export default function Footer() {
    return (
        <div className="flex p-16 justify-between items-center w-full h-[110px]">
            <div className="flex justify-center items-center gap-8 w-fit">
                <div className="flex items-center gap-2 w-fit">
                    <p className="text-[#8DDC8D] font-orbitron text-[56px] font-black leading-[1.1em] w-fit tracking-[-0.03em]">
                        Tasio&#x3D;3
                    </p>
                </div>
            </div>
